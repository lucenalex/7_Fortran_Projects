...
\begin{tikzpicture}
		\begin{axis}[
			...
			\addlegendentry{$\omega = 1.0$}
			\addplot [smooth, very thick] table {dados_freq_1.dat};
			
			\addlegendentry{$\omega = 2.0$}
			\addplot [smooth, very thick] table {dados_freq_2.dat};
			
			\addlegendentry{$\omega = 3.0$}
			\addplot [smooth, very thick] table {dados_freq_3.dat};
			
			\addlegendentry{$\omega = 4.0$}
			\addplot [smooth, very thick] table {dados_freq_4.dat};
